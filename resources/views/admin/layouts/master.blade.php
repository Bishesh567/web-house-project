...
<head>
      ...
      <link rel="shortcut icon" href="{{asset('images/main/'. $logo->fav_icon)}}" type="image/x-icon">
   ...
   <div id="preloader">
     ...
     <script src="https://cdn.tiny.cloud/1/zt5nbe70bcm3q6pdxr8a8tvfoz8t9mpxr0b5q7emlb2synbh/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
     <script>
        tinymce.init({
