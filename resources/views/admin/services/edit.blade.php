         ...
         <div class="col-sm-12">
            <div class="panel panel-bd lobidrag">
               ...
               <div class="panel-body">
                  <form class="col-sm-12" enctype="multipart/form-data" action="{{route('services.update',$detail->id)}}" method="POST">
                     {{csrf_field()}}
                     ...
                     <div class="form-group col-sm-4">
                        ...
                        <img style="width:100px; margin-top: 10px;" src="{{asset('/uploads/events/'.$detail->image)}}">
                        @endif
                     </div>
