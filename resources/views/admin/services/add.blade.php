            ...
            <div class="panel panel-bd lobidrag">
               <div class="panel-heading">
                  <div class="btn-group" id="buttonlist">
                     <a class="btn btn-add " href="{{route('services.index')}}">
                        <i class="fa fa-eye"></i> View Services</a>
                  </div>
               </div>
               <div class="panel-body">
                  <form class="col-sm-12" enctype="multipart/form-data" action="{{route('services.store')}}" method="POST">
                     {{csrf_field()}}
                    
                     <div class="form-group col-sm-12">
                        <label>Service Name</label>
                        <input type="text" class="form-control" placeholder="Enter Service Name" name="name" id="name" value="{{old('name')}}">
                     </div>
                     ...
                     <div class="form-group col-sm-4">
                        <label>Icon(Size: width:70px, height:70px)</label>
